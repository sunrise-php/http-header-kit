...
class HeaderSetCookie extends AbstractHeader implements HeaderInterface
{
	...
	public function setDomain(?string $domain) : self
	{
		...
		{
			throw new \InvalidArgumentException('Cookie domains cannot contain any of the following ",; \\t\\r\\n\\013\\014"');
		}
	...
	public function setPath(?string $path) : self
	{
		...
		{
			throw new \InvalidArgumentException('Cookie paths cannot contain any of the following ",; \\t\\r\\n\\013\\014"');
		}
	...
	public function setSameSite(?string $samesite) : self
	{
		...
		{
			throw new \InvalidArgumentException('Cookie samesites cannot contain any of the following ",; \\t\\r\\n\\013\\014"');
		}
