...
class HeaderSetCookieTest extends TestCase
{
	...
	public function testGetFieldValue()
	{
		...
		$header = new HeaderSetCookie('name', 'value', $now, ['domain' => 'domain.net', 'path' => '/path/', 'secure' => false, 'httponly' => false, 'samesite' => 'strict']);

		$expected = 'name=value; Expires=' . $now->format(\DateTime::RFC822) . '; Max-Age=0; Domain=domain.net; Path=/path/; SameSite=strict';
	...
	public function testToString()
	{
		...
		$header = new HeaderSetCookie('name', 'value', $local, ['domain' => 'domain.net', 'path' => '/path/', 'secure' => true, 'httponly' => true, 'samesite' => 'strict']);

		$expected = 'Set-Cookie: name=value; Expires=' . $utc->format(\DateTime::RFC822) . '; Max-Age=30; Domain=domain.net; Path=/path/; Secure; HttpOnly; SameSite=strict';
