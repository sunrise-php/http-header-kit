...
class HeaderContentTypeTest extends TestCase
{
	...
	public function testToStringWithSeveralParameters()
	{
		...
		$this->assertEquals('Content-Type: type; parameter-name-1="parameter-value-1"; parameter-name-2="parameter-value-2"; parameter-name-3="parameter-value-3"', (string) $header);
	}
