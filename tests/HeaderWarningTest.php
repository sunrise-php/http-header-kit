...
class HeaderWarningTest extends TestCase
{
	...
	public function testGetFieldValueWithDate()
	{
		...
		$this->assertEquals(\sprintf('199 agent "text" "%s"', $utc->format(\DateTime::RFC822)), $header->getFieldValue());
	}
	...
	public function testToStringWithDate()
	{
		...
		$this->assertEquals(\sprintf('Warning: 199 agent "text" "%s"', $utc->format(\DateTime::RFC822)), (string) $header);
	}
